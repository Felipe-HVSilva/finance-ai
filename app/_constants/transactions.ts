...
export const TRANSACTION_PAYMENT_METHOD_ICONS = {
  ...
  [TransactionPaymentMethod.BAN_SLIP]: "bank-slip.svg",
...
export const TRANSACTION_PAYMENT_METHOD_OPTIONS = [
  ...
  {
    value: TransactionPaymentMethod.BAN_SLIP,
    label: TRANSACTION_PAYMENT_METHOD_LABELS[TransactionPaymentMethod.BAN_SLIP],
  },
  {
